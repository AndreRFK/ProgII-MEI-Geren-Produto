 ...
 */
package main.java.br.estacio.mei.model;
...
public class gerenciamentoDeProduto {
    ...
    public int hashCode() {
        ...
        hash = 29 * hash + Float.floatToIntBits(this.valorAtual);
        hash = 29 * hash + Float.floatToIntBits(this.valorAntigo);
        hash = 29 * hash + (int) (Double.doubleToLongBits(this.lucro) ^ (Double.doubleToLongBits(this.lucro) >>> 32));
    ...
    public boolean equals(Object obj) {
        ...
        final gerenciamentoDeProduto other = (gerenciamentoDeProduto) obj;
